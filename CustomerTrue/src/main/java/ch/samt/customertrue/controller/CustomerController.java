package ch.samt.customertrue.controller;

import ch.samt.customertrue.domain.Customer;
import ch.samt.customertrue.domain.MealGroup;
import ch.samt.customertrue.service.CustomerService;
import ch.samt.customertrue.service.MealGroupService;
import ch.samt.customertrue.service.ReservationService;
...
public class CustomerController {
    ...
    @GetMapping("/addCustomerToMealGroup")
    public String loadAddCustomerToMealGroup(Model model) {
        model.addAttribute("mealGroups", mealGroupService.findAll());
        model.addAttribute("customers", customerService.findAll());
        return "addCustomerToMealGroup";
    }
    @PostMapping("/addCustomerToMealGroup")
